function sol = covid_reopen_nopolicy(x0, T_end, n_age_strat, n_work_strat, param_epi, parm_beta)
...
for t = 2:T_end+1
    ...
    for i0 = 1: n_age_strat
        for i1 = 1: n_work_strat
            ...
            x_state(i0, i1, 1, 1, t) = x_state(i0, i1, 1, 1, t-1) + flow_nopolicy_sym + flow_nopolicy_asym;
            ...
            x_state(i0, i1, 1, 2, t) = x_state(i0, i1, 1, 2, t-1) + flow_nopolicy_sym + flow_nopolicy_asym - delta*x_state(i0, i1, 1, 2, t-1);
