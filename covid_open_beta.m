function parm_beta = covid_open_beta(n_age_strat,n_work_strat, v_table_nopolicy, v_table_policy, param_epi)
        ...
        for int_i1 = 1: n_work_strat
            for int_j0 = 1: n_age_strat
                 for int_j1 = 1: n_work_strat
                     ...
                     parm_beta(1, 1, int_i0, int_i1, int_j0, int_j1) = v_table_nopolicy((int_i0-1)*n_age_strat+int_i1,(int_j0-1)*n_age_strat+int_j1)*p*ksi(int_i0,int_i1)*kij(int_j0,int_j1);
    ...
    for int_i0 = 1: n_age_strat
        for int_i1 = 1: n_work_strat
            for int_j0 = 1: n_age_strat
                 for int_j1 = 1: n_work_strat
                     % policy, symptomatic/ asymptomatic
                     parm_beta(2, 1, int_i0, int_i1, int_j0, int_j1) = v_table_policy((int_i0-1)*n_age_strat+int_i1,(int_j0-1)*n_age_strat+int_j1)*p*ksi(int_i0,int_i1)*kij(int_j0,int_j1);
